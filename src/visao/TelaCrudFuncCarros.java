...
public class TelaCrudFuncCarros extends JFrame {
	...
	public TelaCrudFuncCarros() {
		...
		comboAno.setModel(new DefaultComboBoxModel(new String[] { "", "2023", "2022", "2021", "2020", "2019", "2018",
				...
				"1926", "1925", "1924", "1923", "1922", "1921", "1920", "1919", "1918", "1917", "1916", "1915", "1914",
				"1913", "1912", "1911", "1910", "1909", "1908", "1907", "1906", "1905", "1904", "1903", "1902", "1901",
				"1900" }));
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textModelo.getText().equals("") || anoc.equals("") || textCor.getText().equals("")
					...
					String data[] = { textModelo.getText(), (String) comboAno.getSelectedItem(), textCor.getText(),
							textMarca.getText(), textPreco.getText() };
		...
		btnUpdate.setIcon(
				new ImageIcon(TelaCrudFuncCarros.class.getResource("/visao/NicePng_refresh-icon-png_2047577 (1).png")));
		...
		Table1.setModel(
				new DefaultTableModel(new Object[][] {}, new String[] { "Modelo", "Ano", "Cor", "Marca", "Preco" }));
		if (carroDAO == null) {
			carroDAO = CarroDAO.getInstancia();
		}
